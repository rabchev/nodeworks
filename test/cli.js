...
function testResponse(test, verifyPort) {
    ...
    run.start(function (err, port) {
        ...
        http.get(appUrl + port + "/works/", function (res) {
...
module.exports = testCase({
    ...
    "Run on Specific Port": function (test) {
        ...
        process.argv = ["node", "../lib/node_modules/works/bin/run.js", "--IDE.port", "18658"];
    ...
    "Tetst -o --IDE.port Parameters": function (test) {
        ...
        process.argv = ["node", "../lib/node_modules/works/bin/run", "-o", "--IDE.port", "18658"];
    ...
    "Tetst --open Parameter on Rendom Port": function (test) {
        ...
        process.argv = ["node", "../lib/node_modules/works/bin/run", "--open"];
    ...
    "Template Installation With Script": function (test) {
        ...
        process.argv = ["node", "../lib/node_modules/works/bin/run", "-i", "express -e"];
    ...
    "Template Installation Without Script": function (test) {
        ...
        process.argv = ["node", "../lib/node_modules/works/bin/run", "-i", "plain-connect"];
    ...
    "Template Installation on Nonepty Directory with -f (--force) Option": function (test) {
        ...
        process.argv = ["node", "../lib/node_modules/works/bin/run", "-i", "plain-connect", "-f"];
    ...
    "Run Without Arguments - No Callback": function (test) {
        ...
        var run = rewire("../bin/run");
        resetCommander();
        process.argv = ["node", "../lib/node_modules/works/bin/run"];
